...
namespace PLCSocket
{
    public class PLCAddressHelper
    {
        ...
        {
            string address = "%01#RDD";// "%01#RDD0030100309**";报文
    ...
    //    %01#RDD0118001195**
        ...
        public static bool ValueInfo(string str)
         {
             //返回报文%01$RC120
             string switch_on = str.Substring(6, str.Length - 9);
        ...
        /// <returns></returns>
        public static string DTAddressWriteConvert(int beginAddress, int endAddress,List<string> values)
        {
